package com.innowise.ball_factory.quick;
...
import com.innowise.ball_factory.sorts.quick.QuickSort;
...
public class QuickSortSeveralAttributesTest {
    ...
    public void ascNameAscWeightSort() {
        ...
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder()
    ...
    public void typePriorityToLargeColorCustomPrioritySort() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, ballComparator);
