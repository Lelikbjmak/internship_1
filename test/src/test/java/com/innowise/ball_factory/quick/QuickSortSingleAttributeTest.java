...
public class QuickSortSingleAttributeTest {
    ...
    public void ascSortByName() {
        ...
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().nameComparator());
    ...
    public void ascSortByWeight() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().weightComparator());
    ...
    public void descSortByWeight() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().weightComparator().reversed());
    ...
    public void ascSortByColor() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().colorComparator());
    ...
    public void descSortByColor() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().colorComparator().reversed());
    ...
    public void ascSortByType() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().typeComparator());
    ...
    public void descSortByType() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().typeComparator().reversed());
    ...
    public void ascSortByCircumference() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().circumferenceComparator());
    ...
    public void descSortByCircumference() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new QuickSort<>(), BALLS, new BallComparatorBuilder().circumferenceComparator().reversed());
