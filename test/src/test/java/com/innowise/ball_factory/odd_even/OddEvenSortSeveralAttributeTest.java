package com.innowise.ball_factory.odd_even;
...
import com.innowise.ball_factory.sorts.odd_even.OddEvenSort;
import org.junit.jupiter.api.*;

import java.util.*;

public class OddEvenSortSeveralAttributeTest {
    ...
    public void ascNameAscWeightSort() {
        ...
        service.sort(new OddEvenSort<>(), BALLS, new BallComparatorBuilder()
    ...
    public void typePriorityToLargeColorCustomPrioritySort() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new OddEvenSort<>(), BALLS, ballComparator);
