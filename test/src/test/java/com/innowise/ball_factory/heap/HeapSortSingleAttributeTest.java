...
public class HeapSortSingleAttributeTest {
    ...
    public void ascSortByName() {
        ...
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().nameComparator());
    ...
    public void descSortByName() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().nameComparator().reversed());
    ...
    public void ascSortByWeight() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().weightComparator());
    ...
    public void descSortByWeight() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().weightComparator().reversed());
    ...
    public void ascSortByColor() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().colorComparator());
    ...
    public void descSortByColor() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().colorComparator().reversed());
    ...
    public void ascSortByType() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().typeComparator());
    ...
    public void descSortByType() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().typeComparator().reversed());
    ...
    public void ascSortByCircumference() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().circumferenceComparator());
    ...
    public void descSortByCircumference() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder().circumferenceComparator().reversed());
