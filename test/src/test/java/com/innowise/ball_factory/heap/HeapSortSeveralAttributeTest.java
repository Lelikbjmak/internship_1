package com.innowise.ball_factory.heap;
...
public class HeapSortSeveralAttributeTest {
    ...
    public void ascNameAscWeightSort() {
        ...
        service.sort(new HeapSort<>(), BALLS, new BallComparatorBuilder()
    ...
    public void typePriorityToLargeColorCustomPrioritySort() {
        ...
        SortingService<Ball> service = new SortingService<>();
        service.sort(new HeapSort<>(), BALLS, ballComparator);
