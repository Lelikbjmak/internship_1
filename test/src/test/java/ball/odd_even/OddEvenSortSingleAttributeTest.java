...
public class OddEvenSortSingleAttributeTest {
    ...
    public void ascSortByName() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_NAME));
    ...
    public void descSortByName() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_NAME));
    ...
    public void ascSortByWeight() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_WEIGHT));
    ...
    public void descSortByWeight() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_WEIGHT));
    ...
    public void ascSortByColor() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_COLOR));
    ...
    public void descSortByColor() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_COLOR));
    ...
    public void ascSortByType() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_TYPE));
    ...
    public void descSortByType() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_TYPE));
    ...
    public void ascSortByCircumference() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_CIRCUMFERENCE));
    ...
    public void descSortByCircumference() {
        ...
        SortingAlgorithm.oddEvenSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_CIRCUMFERENCE));
