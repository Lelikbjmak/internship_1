...
public class MergeSortSingleAttributeTest {
    ...
    public void contextLoad() {
        ...
        Assertions.assertNotNull(ball.sorts.merge.MergeSort.class);
    }
    ...
    public void ascSortByName() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_NAME));
    ...
    public void descSortByName() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_NAME));
    ...
    public void ascSortByWeight() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_WEIGHT));
    ...
    public void descSortByWeight() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_WEIGHT));
    ...
    public void ascSortByColor() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_COLOR));
    ...
    public void descSortByColor() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_COLOR));
    ...
    public void ascSortByType() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_TYPE));
    ...
    public void descSortByType() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_TYPE));
    ...
    public void ascSortByCircumference() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_CIRCUMFERENCE));
    ...
    public void descSortByCircumference() {
        ...
        SortingAlgorithm.mergeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_CIRCUMFERENCE));
