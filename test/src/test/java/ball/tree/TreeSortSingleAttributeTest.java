...
public class TreeSortSingleAttributeTest {
    ...
    public void contextLoad() {
        ...
        Assertions.assertNotNull(TreeSort.class);
    }
    ...
    public void ascSortByName() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_NAME));
    ...
    public void descSortByName() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_NAME));
    ...
    public void ascSortByWeight() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_WEIGHT));
    ...
    public void descSortByWeight() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_WEIGHT));
    ...
    public void ascSortByColor() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_COLOR));
    ...
    public void descSortByColor() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_COLOR));
    ...
    public void ascSortByType() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_TYPE));
    ...
    public void descSortByType() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_TYPE));
    ...
    public void ascSortByCircumference() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_CIRCUMFERENCE));
    ...
    public void descSortByCircumference() {
        ...
        SortingAlgorithm.treeSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_CIRCUMFERENCE));
