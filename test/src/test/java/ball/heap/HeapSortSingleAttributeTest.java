...
public class HeapSortSingleAttributeTest {
    ...
    public void contextLoad() {
        ...
        Assertions.assertNotNull(HeapSort.class);
    }
    ...
    public void ascSortByName() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_NAME));
    ...
    public void descSortByName() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_NAME));
    ...
    public void ascSortByWeight() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_WEIGHT));
    ...
    public void descSortByWeight() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_WEIGHT));
    ...
    public void ascSortByColor() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_COLOR));
    ...
    public void descSortByColor() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_COLOR));
    ...
    public void ascSortByType() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_TYPE));
    ...
    public void descSortByType() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_TYPE));
    ...
    public void ascSortByCircumference() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.ASC_CIRCUMFERENCE));
    ...
    public void descSortByCircumference() {
        ...
        SortingAlgorithm.heapSort(BALLS, BallComparatorFactory.getBallComparator.apply(ComparatorType.DESC_CIRCUMFERENCE));
